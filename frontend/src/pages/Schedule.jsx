...
import { Play, Calendar as CalendarIcon, Clock, AlertTriangle, CheckCircle2, Zap, Info, MonitorOff, Monitor } from 'lucide-react';
                ...
                <div key={task.id} className="relative flex">
                  ...
                  <div className="flex-1 py-4 pr-4 border-b border-[var(--border-subtle)]">
                    ...
                    <div className="flex gap-2">
                      ...
                      {task.is_screen_free ? (
                        <span className="inline-flex items-center gap-1 mt-1.5 text-[10px] font-bold uppercase tracking-wide text-indigo-600 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 px-2 py-0.5 rounded-md"><MonitorOff size={10} /> Screen-Free</span>
                      ) : (
                        <span className="inline-flex items-center gap-1 mt-1.5 text-[10px] font-bold uppercase tracking-wide text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 px-2 py-0.5 rounded-md"><Monitor size={10} /> On-Screen</span>
                      )}
                    </div>
                  </div>
                </div>
