      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-[var(--bg-app)]">
        <div className="w-full max-w-md flex flex-col">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-panel)] hover:bg-[var(--bg-hover)] transition-colors mb-6 font-semibold text-[var(--text-main)] shadow-sm cursor-pointer"
          >
